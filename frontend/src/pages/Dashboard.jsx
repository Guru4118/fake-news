    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="about" className="py-12 bg-gray-900" data-aos="fade-down" data-aos-duration="1500">
        <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 px-4 text-center lg:text-left" data-aos="fade-right">
          ...
          <div className="lg:w-1/2 px-4 mt-6 lg:mt-0">
            <img
              data-aos="fade-left"
              src="https://img.freepik.com/premium-photo/fact-fake-concept-flip-blocks-change-word-fake-fact-april-fools-day_136875-3607.jpg"
      ...
      {/* Contact Us */}
      <section id="contact" className="py-12 bg-gray-800 text-white" data-aos="fade-up" data-aos-duration="1500">
        <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-1/2 px-4 mt-6 lg:mt-0">
            ...
            >
              <div className="mb-4">
                ...
                <input type="text" name="name" required className="w-full p-2 rounded bg-gray-900 text-white border border-green-500 focus:outline-none focus:ring-2 focus:ring-green-600" />
              </div>
              <div className="mb-4">
                <label className="block text-green-400 mb-1">Email</label>
                <input type="email" name="email" required className="w-full p-2 rounded bg-gray-900 text-white border border-green-500 focus:outline-none focus:ring-2 focus:ring-green-600" />
              </div>
              <div className="mb-4">
                <label className="block text-green-400 mb-1">Phone Number</label>
                <input type="tel" name="phone" className="w-full p-2 rounded bg-gray-900 text-white border border-green-500 focus:outline-none focus:ring-2 focus:ring-green-600" />
              </div>
              <div className="mb-4">
                <label className="block text-green-400 mb-1">Your Query</label>
                <textarea name="query" rows="4" required className="w-full p-2 rounded bg-gray-900 text-white border border-green-500 focus:outline-none focus:ring-2 focus:ring-green-600"></textarea>
              </div>
              <button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded transition-all duration-300">Submit</button>
            </form>
          </div>
        </div>
      </section>
